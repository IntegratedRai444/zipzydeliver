...
import type { Order, OrderItem, Product, OrderTracking as OrderTrackingType, OrderDelivery } from '@shared/schema';
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {showPaymentQr && order.paymentQrCode && (
                  <div className="text-center p-4 border rounded-lg">
