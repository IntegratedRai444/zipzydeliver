...
((SELECT id FROM conversations WHERE title LIKE '%ZPY202501270001%' LIMIT 1), (SELECT id FROM orders WHERE order_number = 'ZPY202501270001'), 'bot', 'admin-user-id', 'bot', 'Your order ZPY202501270001 is currently being prepared. Estimated delivery time is 25 minutes.', 'text')
ON CONFLICT DO NOTHING;